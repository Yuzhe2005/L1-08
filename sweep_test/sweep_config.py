...
class SweepSettings:
    ...
    def from_json(cls, config_path: Path) -> "SweepSettings":
        ...
        return cls(
            ...
            l1_08_sim_dir=_resolve_path(config_path, str(paths.get("l1_08_sim_dir", paths.get("sim_dir", "L1-08_sim")))),
            l1_09_sim_dir=_resolve_path(config_path, str(paths.get("l1_09_sim_dir", "L1_09_sim"))),
            l1_08_config=_resolve_path(config_path, str(paths.get("l1_08_config", paths.get("base_experiment_config", "L1_08_experiment_config.json")))),
            l1_09_config=_resolve_path(config_path, str(paths.get("l1_09_config", "L1_09_experiment_config.json"))),
            input_config=_resolve_path(config_path, str(paths.get("input_config", "input_config.json"))),
    ...
    def current_seed_label(self) -> str:
        ...
        base = json.loads(self.l1_08_config.read_text(encoding="utf-8"))
