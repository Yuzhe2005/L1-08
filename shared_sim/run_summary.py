...
from shared_sim.config import load_base_plan_config, load_input_config, load_plan_b_config
...
def update_run_summary(
    ...
    summary["input_config"] = _jsonable(load_input_config())

    summary["param_config"] = _jsonable(load_base_plan_config())
